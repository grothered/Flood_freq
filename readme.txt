...
The script 'prof_liklihood.R' fits various curves to annual maxima data using the method of maximum likelihood, with profile likelihood confidence intervals. DON'T TRUST THIS IT NEEDS WORK / TESTING
